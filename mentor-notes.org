...
- 15:35-16:00 :: dictionaries & sets (examples of unordered collections)
  - make some dictionaries 
  - get stuff back out
  - make some sets of things

  - functions as mappings (input -> output) just like maps are key -> value
...
- 16:05-16:35 :: interfaces / protocols by example
